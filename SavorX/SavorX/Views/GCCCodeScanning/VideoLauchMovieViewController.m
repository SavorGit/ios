//
//  VideoLauchMovieViewController.m
//  SavorX
//
...
@interface VideoLauchMovieViewController ()
/** 播放开始之前的图片 */
...
@implementation VideoLauchMovieViewController
...
- (void)enterMain {
    ...
    if (_lauchClickedBack) {
        _lauchClickedBack(nil);
    }
