...
#define kPingFangRegular(x) [UIFont fontWithName:@"PingFangSC-Regular" size:x]
#define kPingFangThin(x) [UIFont fontWithName:@"PingFangSC-Thin" size:x]
#define kPingFangLight(x) [UIFont fontWithName:@"PingFangSC-Light" size:x]
#define kPingFangMedium(x) [UIFont fontWithName:@"PingFangSC-Medium" size:x]
