...
- (instancetype)init
{
    NSArray * vcArray = @[[RDHomeScreenViewController class],[LiveViewController class],[RealCreateWealthViewController class]];
    NSArray * titleArray = @[RDLocalizedString(@"RDString_Screen"),  RDLocalizedString(@"RDString_Live"), RDLocalizedString(@"RDString_CreateWealth")];
