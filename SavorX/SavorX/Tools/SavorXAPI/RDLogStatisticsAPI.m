...
+ (void)wantToSeeSee
{
    [[NSFileManager defaultManager] copyItemAtPath:RDLogPath toPath:[NSString stringWithFormat:@"/Users/guochuncheng/Desktop/%@_%@.log", [GlobalData shared].deviceID, [Helper getCurrentTimeWithFormat:@"yyyyMMddHHmm"]] error:nil];
    [[NSFileManager defaultManager] removeItemAtPath:RDLogPath error:nil];
}
